...
CREATE TABLE `pokemon` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `numero_2` (`number`),
  KEY `numero` (`number`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `pokemon` (`id`, `name`, `hp`, `attack`, `defense`, `attack_spe`, `defense_spe`, `speed`, `number`) VALUES
...
CREATE TABLE `pokemon_type` (
  ...
  `pokemon_numero` int unsigned NOT NULL,
  `type_id` int unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `type_id` (`type_id`),
  KEY `pokemon_numero` (`pokemon_numero`),
  CONSTRAINT `pokemon_type_ibfk_1` FOREIGN KEY (`type_id`) REFERENCES `type` (`id`),
  CONSTRAINT `pokemon_type_ibfk_2` FOREIGN KEY (`pokemon_numero`) REFERENCES `pokemon` (`number`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
